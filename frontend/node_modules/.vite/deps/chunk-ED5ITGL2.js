import {
  ...
  WindowContext,
  useLocaleText
} from "./chunk-SJE47IOC.js";
import {
  Avatar_default,
  avatarClasses_default
} from "./chunk-UDVMBEK3.js";
import {
  Badge_default,
  ClickAwayListener,
  FirstPage_default,
...
import {
  ...
  Button_default,
  Transition_default
} from "./chunk-PYOR5SZZ.js";
import {
  require_react_dom
} from "./chunk-DLJIGNKJ.js";
import {
  SvgIcon_default,
  ...
  useForkRef_default,
  useId_default
} from "./chunk-BWVZUVNQ.js";
import {
  InitColorSchemeScript_default,
  ThemeProvider,
  useColorScheme
} from "./chunk-45L6OLEO.js";
import {
  Typography_default,
  typographyClasses_default
} from "./chunk-OSW2KA5P.js";
import {
...
import {
  ...
  globalCss,
  memoTheme_default
} from "./chunk-WVYFWVFN.js";
import {
  useDefaultProps
} from "./chunk-MOD2PCEE.js";
import {
  useTheme
} from "./chunk-7H35WEZW.js";
import {
  HTMLElementType,
  alpha,
  chainPropTypes,
  ...
  useTimeout
} from "./chunk-NJ4WSONV.js";
import {
  require_prop_types
} from "./chunk-524EIQRZ.js";
import {
  require_jsx_runtime
} from "./chunk-NZQAZV5F.js";
import {
  require_react
} from "./chunk-I2N3ICTL.js";
import {
  __commonJS,
  __toESM
...
var MobileStepper = React50.forwardRef(function MobileStepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime44.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [backButton, variant === "text" && (0, import_jsx_runtime44.jsxs)(React50.Fragment, {
...
var NativeSelect = React51.forwardRef(function NativeSelect2(inProps, ref) {
  ...
  return (0, import_jsx_runtime45.jsx)(React51.Fragment, {
...
var SpeedDial = React69.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  return (0, import_jsx_runtime59.jsxs)(SpeedDialRoot, {
    className: clsx_default(classes.root, className),
    ref,
    role: "presentation",
...
var StepLabel = React79.forwardRef(function StepLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime67.jsxs)(StepLabelRoot, {
    className: clsx_default(classes.root, className),
    ref,
    ownerState,
    ...other,
...
var Close_default = createSvgIcon((0, import_jsx_runtime89.jsx)("path", {
...
function useNonNullableContext(context, name) {
  const maybeContext = React104.useContext(context);
...
var _CloseIcon;
var RootPropsContext = React106.createContext(null);
...
function Notification({
  ...
  const handleClose = React106.useCallback((event, reason) => {
    if (reason === "clickaway") {
      return;
    }
    close(notificationKey);
  }, [notificationKey, close]);
  const action = (0, import_jsx_runtime91.jsxs)(React106.Fragment, {
    children: [onAction ? (0, import_jsx_runtime91.jsx)(Button_default, {
      color: "inherit",
      size: "small",
      onClick: onAction,
      children: actionText ?? "Action"
    }) : null, (0, import_jsx_runtime91.jsx)(IconButton_default, {
      size: "small",
      "aria-label": localeText == null ? void 0 : localeText.close,
      title: localeText == null ? void 0 : localeText.close,
      color: "inherit",
      onClick: handleClose,
      children: _CloseIcon || (_CloseIcon = (0, import_jsx_runtime91.jsx)(Close_default, {
        fontSize: "small"
      }))
    })]
  });
  const props = React106.useContext(RootPropsContext);
  ...
  return (0, import_jsx_runtime91.jsx)(SnackbarComponent, {
    ...snackbarSlotProps,
    children: (0, import_jsx_runtime91.jsx)(Badge_default, {
      badgeContent: badge,
      color: "primary",
      sx: {
        width: "100%"
      },
      children: severity ? (0, import_jsx_runtime91.jsx)(Alert_default, {
        severity,
        sx: {
          width: "100%"
        },
        action,
        children: message
      }) : (0, import_jsx_runtime91.jsx)(SnackbarContent_default, {
        message,
        action
      })
    })
...
function Notifications({
  ...
  return currentNotification ? (0, import_jsx_runtime91.jsx)(Notification, {
    ...currentNotification,
...
function NotificationsProvider(props) {
  ...
  const [state, setState] = React106.useState({
    queue: []
  });
  const show = React106.useCallback((message, options = {}) => {
  ...
  const close = React106.useCallback((key) => {
    setState((prev) => ({
      ...prev,
  ...
  return (0, import_jsx_runtime91.jsx)(RootPropsContext.Provider, {
    value: props,
    children: (0, import_jsx_runtime91.jsxs)(NotificationsContext.Provider, {
      value: contextValue,
      children: [children, (0, import_jsx_runtime91.jsx)(Notifications, {
        state
      })]
    })
  });
...
var DialogsContext = React107.createContext(null);
...
var useEnhancedEffect = typeof window !== "undefined" ? React109.useLayoutEffect : React109.useEffect;
var useEnhancedEffect_default3 = useEnhancedEffect;

// node_modules/@toolpad/core/node_modules/@mui/utils/esm/useEventCallback/useEventCallback.js
function useEventCallback(fn) {
  const ref = React110.useRef(fn);
  useEnhancedEffect_default3(() => {
    ref.current = fn;
  });
  return React110.useRef((...args) => (
...
function DialogsProvider(props) {
  ...
  const [stack, setStack] = React111.useState([]);
  const keyPrefix = React111.useId();
  const nextId2 = React111.useRef(0);
  const requestDialog = useEventCallback_default3(function open(Component, payload, options = {}) {
    const {
      onClose = async () => {
      }
    } = options;
  ...
  const closeDialogUi = useEventCallback_default3(function closeDialogUi2(dialog) {
  ...
  const closeDialog = useEventCallback_default3(async function closeDialog2(dialog, result) {
  ...
  return (0, import_jsx_runtime93.jsxs)(DialogsContext.Provider, {
    value: contextValue,
    children: [children, stack.map(({
      ...
      payload,
      promise
    }) => (0, import_jsx_runtime93.jsx)(Component, {
      payload,
      open,
...
function useStorageState(area, key, initializer = null, options) {
  ...
  const [initialValue] = React112.useState(initializer);
  const encodedInitialValue = React112.useMemo(() => encode(codec, initialValue), [codec, initialValue]);
  const subscribeKey = React112.useCallback((callback) => subscribe(area, key, callback), [area, key]);
  const getKeySnapshot = React112.useCallback(() => getSnapshot(area, key) ?? encodedInitialValue, [area, encodedInitialValue, key]);
  const encodedStoredValue = React112.useSyncExternalStore(subscribeKey, getKeySnapshot, getKeyServerSnapshot);
  const storedValue = React112.useMemo(() => decode(codec, encodedStoredValue), [codec, encodedStoredValue]);
  const setStoredValue = React112.useCallback((value) => {
  ...
  const [nonStoredValue, setNonStoredValue] = React112.useState(initialValue);
  if (!key) {
...
function LegacyThemeProvider(props) {
  ...
  const dualAwareTheme = React113.useMemo(() => isDualTheme ? theme[paletteMode === "dark" ? "dark" : "light"] ?? theme[paletteMode === "dark" ? "light" : "dark"] : theme, [isDualTheme, paletteMode, theme]);
  const paletteModeContextValue = React113.useMemo(() => ({
    paletteMode,
    setPaletteMode: setUserMode,
    isDualTheme
  }), [isDualTheme, paletteMode, setUserMode]);
  return (0, import_jsx_runtime94.jsx)(ThemeProvider, {
    theme: dualAwareTheme,
    children: (0, import_jsx_runtime94.jsxs)(PaletteModeContext.Provider, {
      value: paletteModeContextValue,
      children: [_CssBaseline || (_CssBaseline = (0, import_jsx_runtime94.jsx)(CssBaseline_default, {
        enableColorScheme: true
      })), children]
    })
  });
...
function CssVarsPaletteModeProvider(props) {
  ...
  return (0, import_jsx_runtime94.jsx)(PaletteModeContext.Provider, {
    value: paletteModeContextValue,
    children
  });
}
function CssVarsThemeProvider(props) {
  ...
  return (0, import_jsx_runtime94.jsxs)(ThemeProvider, {
    theme,
    ...
    children: [_InitColorSchemeScrip || (_InitColorSchemeScrip = (0, import_jsx_runtime94.jsx)(InitColorSchemeScript_default, {
      attribute: COLOR_SCHEME_ATTRIBUTE,
      colorSchemeStorageKey: COLOR_SCHEME_STORAGE_KEY,
      modeStorageKey: MODE_STORAGE_KEY
    })), (0, import_jsx_runtime94.jsxs)(CssVarsPaletteModeProvider, {
      window: appWindow,
      children: [_CssBaseline2 || (_CssBaseline2 = (0, import_jsx_runtime94.jsx)(CssBaseline_default, {
        enableColorScheme: true
      })), children]
    })]
  });
...
function AppThemeProvider(props) {
  ...
  return useCssVarsProvider ? (0, import_jsx_runtime94.jsx)(CssVarsThemeProvider, {
    theme,
    ...rest,
    children
  }) : (0, import_jsx_runtime94.jsx)(LegacyThemeProvider, {
    theme,
    ...rest,
    children
  });
...
var AuthenticationContext = React114.createContext(null);
var SessionContext = React114.createContext(null);
...
function AppProvider(props) {
  ...
  return (0, import_jsx_runtime95.jsx)(WindowContext.Provider, {
    value: appWindow,
    children: (0, import_jsx_runtime95.jsx)(AuthenticationContext.Provider, {
      value: authentication,
      children: (0, import_jsx_runtime95.jsx)(SessionContext.Provider, {
        value: session,
        children: (0, import_jsx_runtime95.jsx)(RouterContext.Provider, {
          value: router,
          children: (0, import_jsx_runtime95.jsx)(AppThemeProvider, {
            theme,
            window: appWindow,
            children: (0, import_jsx_runtime95.jsx)(LocalizationProvider, {
              localeText,
              children: (0, import_jsx_runtime95.jsx)(NotificationsProvider, {
                children: (0, import_jsx_runtime95.jsx)(DialogsProvider, {
                  children: (0, import_jsx_runtime95.jsx)(BrandingContext.Provider, {
                    value: branding,
                    children: (0, import_jsx_runtime95.jsx)(NavigationContext.Provider, {
                      value: navigation,
                      children
                    })
                  })
...
true ? AppProvider.propTypes = {
   ...
   * @default null
   */
  authentication: import_prop_types83.default.shape({
    signIn: import_prop_types83.default.func.isRequired,
    signOut: import_prop_types83.default.func.isRequired
  }),
  /**
   * Branding options for the app.
   * @default null
   */
  branding: import_prop_types83.default.shape({
    homeUrl: import_prop_types83.default.string,
    logo: import_prop_types83.default.node,
   ...
   */
  localeText: import_prop_types83.default.object,
  /**
   * Navigation definition for the app. [Find out more](https://mui.com/toolpad/core/react-app-provider/#navigation).
   * @default []
   */
  navigation: import_prop_types83.default.arrayOf(import_prop_types83.default.oneOfType([import_prop_types83.default.shape({
    action: import_prop_types83.default.node,
    children: import_prop_types83.default.arrayOf(import_prop_types83.default.oneOfType([import_prop_types83.default.object, import_prop_types83.default.shape({
      kind: import_prop_types83.default.oneOf(["header"]).isRequired,
      title: import_prop_types83.default.string.isRequired
    }), import_prop_types83.default.shape({
      kind: import_prop_types83.default.oneOf(["divider"]).isRequired
    })]).isRequired),
    icon: import_prop_types83.default.node,
    kind: import_prop_types83.default.oneOf(["page"]),
    pattern: import_prop_types83.default.string,
    segment: import_prop_types83.default.string,
    title: import_prop_types83.default.string
  }), import_prop_types83.default.shape({
    kind: import_prop_types83.default.oneOf(["header"]).isRequired,
    title: import_prop_types83.default.string.isRequired
   ...
   * @default null
   */
  router: import_prop_types83.default.shape({
    Link: import_prop_types83.default.func,
    navigate: import_prop_types83.default.func.isRequired,
    pathname: import_prop_types83.default.string.isRequired,
    searchParams: import_prop_types83.default.instanceOf(URLSearchParams).isRequired
  }),
  /**
   * Session info about the current user.
   * @default null
   */
  session: import_prop_types83.default.shape({
    user: import_prop_types83.default.shape({
      email: import_prop_types83.default.string,
      id: import_prop_types83.default.string,
      image: import_prop_types83.default.string,
   ...
   * @default window
   */
  window: import_prop_types83.default.object
} : void 0;
...
@mui/material/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ED5ITGL2.js.map
